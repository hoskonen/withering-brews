...
WitheringBrews.Config = {
    ...
    Bootstrap = {
        enable        = true,
        db_flag       = "WB_Config:migrated_v1",               -- marks migration done
        affect        = { player = true, stash = false, saddle = false }, -- what to scan/seed
        -- Per-band age seeding windows (in days) per tier (iv..i)
        seed_age_days = {
            water  = { iv = { 0, 2 }, iii = { 2, 6 }, ii = { 6, 10 }, i = { 10, 14 } },
            wine   = { iv = { 0, 4 }, iii = { 4, 10 }, ii = { 10, 18 }, i = { 18, 28 } },
            oil    = { iv = { 0, 60 }, iii = { 0, 90 }, ii = { 0, 120 }, i = { 0, 180 } }, -- long-lived
            spirit = { iv = { 0, 120 }, iii = { 0, 160 }, ii = { 0, 200 }, i = { 0, 240 } }, -- very long-lived
        },
    },
    PotionReplacers = {
